...
test.getRegmethod.call <- function()
{
    ...
    obj.PBequi <-mcreg(data.x, data.y, method.reg = "PBequi") 
    obj.TS <-mcreg(data.x, data.y, method.reg = "TS") 
    ...
    checkEquals( getRegmethod(obj.PBequi), "PBequi")
    checkEquals( getRegmethod(obj.TS), "TS")
